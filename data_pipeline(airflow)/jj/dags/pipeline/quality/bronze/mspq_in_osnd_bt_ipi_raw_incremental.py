...
from dags.pipeline.quality.bronze.common.mspq_in_osnd_bt_ipi_raw_common import (
    parse_datetime,
    extract_data,
    load_data,
    update_variable,
...
INCREMENT_KEY = "last_extract_time_mspq_in_osnd_bt_ipi_raw"
...
# ────────────────────────────────────────────────────────────────
with DAG(
    dag_id="mspq_in_osnd_bt_ipi_raw_incremental",
    default_args=DEFAULT_ARGS,
    schedule_interval=None,  # 매일 실행
    start_date=datetime(2025, 1, 1),
    catchup=False,
    tags=["JJ","raw", "IP","IPI", "bronze layer", "incremental", "quality"]  # ✅ 태그 통일
) as dag:
