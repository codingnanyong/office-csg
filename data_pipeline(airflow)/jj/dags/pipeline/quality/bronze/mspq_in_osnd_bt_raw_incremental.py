...
from dags.pipeline.quality.bronze.common.mspq_in_osnd_bt_raw_common import (
    parse_datetime,
    extract_data,
    load_data,
    update_variable,
...
INCREMENT_KEY = "last_extract_time_mspq_in_osnd_bt_raw"
...
# ────────────────────────────────────────────────────────────────
with DAG(
    dag_id="mspq_in_osnd_bt_raw_incremental",
    default_args=DEFAULT_ARGS,
    schedule_interval="@daily",  # 매일 실행
    start_date=datetime(2025, 1, 1),
    catchup=False,
    tags=["JJ","raw", "bronze layer", "incremental", "quality", "daily"]  # ✅ 태그 통일
) as dag:
