"""MCH Machine Raw Backfill DAG (Oracle → Bronze)"""
import logging
...
with DAG(
    dag_id='mch_machine_raw_backfill',
    default_args=DEFAULT_ARGS,
    description='Machine Master Raw Data Backfill (Monthly Batch)',
    schedule_interval=None,
    start_date=datetime(2024, 1, 1),
    catchup=False,
    tags=['JJ', 'maintenance', 'bronze layer', 'backfill', 'machine', 'master'],
) as dag:
