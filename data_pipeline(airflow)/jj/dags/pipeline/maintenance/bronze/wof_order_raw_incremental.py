"""WOF Order Raw Incremental DAG (Oracle → Bronze)"""
import logging
...
with DAG(
    dag_id='wof_order_raw_incremental',
    default_args=DEFAULT_ARGS,
    description='Work Order Raw Data Incremental (Daily)',
    schedule_interval=None,
    start_date=datetime(2024, 1, 1),
    catchup=False,
    tags=['JJ', 'maintenance', 'bronze layer', 'incremental', 'work_order'],
) as dag:
