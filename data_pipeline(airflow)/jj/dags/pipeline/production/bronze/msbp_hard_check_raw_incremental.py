...
from dags.pipeline.production.bronze.common.msbp_hard_check_raw_common import (
    parse_datetime,
    extract_data,
    load_data,
    update_variable,
...
INCREMENT_KEY = "last_extract_time_msbp_hard_check_raw"
...
# ────────────────────────────────────────────────────────────────
with DAG(
    dag_id="msbp_hard_check_raw_incremental",
