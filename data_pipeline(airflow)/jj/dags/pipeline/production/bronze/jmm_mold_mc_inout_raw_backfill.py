...
from dags.pipeline.production.bronze.common.jmm_mold_mc_inout_raw_common import (
    parse_datetime,
    get_month_end_date,
...
INCREMENT_KEY = "last_extract_time_jmm_mold_mc_inout_raw"
...
# ────────────────────────────────────────────────────────────────
with DAG(
    dag_id="jmm_mold_mc_inout_raw_backfill",
    default_args=DEFAULT_ARGS,
    schedule_interval="@once",
    start_date=datetime(2025, 1, 1),
    catchup=False,
    tags=["JJ","CKP","raw", "bronze layer", "backfill", "production", "monthly"]
) as dag:
