...
from dags.pipeline.production.bronze.common.ipi_mc_output_v2_raw_common import (
    parse_datetime,
    get_month_end_date,
...
INCREMENT_KEY = "last_extract_time_ipi_mc_output_v2_raw"
...
def backfill_monthly_batch_task(**kwargs) -> dict:
    ...
    while current_date < end_date:
        ...
        batch_result = process_monthly_batch(
            mssql, pg, current_date, month_end, loop_count, expected_loops
        )
...
# ────────────────────────────────────────────────────────────────
with DAG(
    dag_id="ipi_mc_output_v2_raw_backfill",
    default_args=DEFAULT_ARGS,
    schedule_interval="@once",
    start_date=datetime(2025, 1, 1),
    catchup=False,
    tags=["CKP","IP","raw", "bronze layer", "backfill", "production", "monthly"]
) as dag:
