...
// - 2023.06.20 taehyeon.ryu : DbServerKind Add(PostgreSQL,MariaDB,MySQL,OracleService - Connection type SERVICE_NAME)
// - 2024.04.01 taehyeon.ryu : DeltaFieldType Add (Int64 : UnixTime)
//===============================================================================

namespace CSG.MI.AutoETL.Core
{
	public enum DbServerKind
	{
		None = -1,
		SqlServer,
		SqlServerV8,
