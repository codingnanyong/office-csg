...
{
	/// <summary>
	/// RTLS) Work In Process API.
	/// </summary>
	[ApiController]
	[Route("v{version:apiVersion}/rtls/[controller]")]
	[ApiVersion("1.5")]
	public class RtlsWipController : ControllerBase
	{
		#region Constructors

		private readonly IRtlsWipRepo _repo;
		...
		public RtlsWipController(IRtlsWipRepo repo, ILoggerManager logger
		...
		public async Task<IActionResult> GetProductionsAsync()
		{
			...
			{
				_logger.LogError(ex, "An error occurred in GET /Wip/productions/async.");
